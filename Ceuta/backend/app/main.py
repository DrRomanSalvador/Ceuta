...
from app.security.middleware import SecurityActionMiddleware
...
# This object is the executable authorization boundary for every future
# consequential API route. System-health routes remain intentionally public.
SECURITY_ENFORCER = SecurityEnforcer()
app.add_middleware(SecurityActionMiddleware, enforcer=SECURITY_ENFORCER)
...
async def diagnostics() -> dict[str, object]:
    return {
        ...
        "security": {"enforcement_boundary": "active"},
    }
...
async def unhandled_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    """Prevent internal exception disclosure to clients."""
    LOGGER.exception(
