...
async def evaluate_decision(payload:DecisionRequest,request:Request):
    ...
    try:
        ...
        final_epistemic=_final_epistemic_assessment(payload,evidence); gate_event=DecisionAuditChain(store).append(payload.decision_id,"final_epistemic_gate",{"validity":final_epistemic.validity.value,"composition":final_epistemic.composition.value,"reasons":final_epistemic.reasons,"anchor_status":final_epistemic.anchor.status.value,"anchor_established":False})
