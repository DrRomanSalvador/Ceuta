...
ALLOWED_TRANSITIONS={
 MissionState.UNKNOWN:{MissionState.DISCOVERED}, MissionState.DISCOVERED:{MissionState.REGISTERED},
 MissionState.REGISTERED:{MissionState.BOOTSTRAP_PENDING,MissionState.SUSPENDED}, MissionState.BOOTSTRAP_PENDING:{MissionState.BOOTSTRAPPED,MissionState.RECOVERY_REQUIRED},
 MissionState.BOOTSTRAPPED:{MissionState.READY,MissionState.RECOVERY_REQUIRED}, MissionState.READY:{MissionState.ACTIVE,MissionState.BLOCKED,MissionState.WAITING_INTERNAL,MissionState.WAITING_EXTERNAL},
 ...
 MissionState.BLOCKED:{MissionState.ACTIVE,MissionState.WAITING_INTERNAL,MissionState.WAITING_EXTERNAL,MissionState.RECOVERY_REQUIRED}, MissionState.WAITING_EXTERNAL:{MissionState.ACTIVE,MissionState.BLOCKED,MissionState.RECOVERY_REQUIRED},
 MissionState.WAITING_INTERNAL:{MissionState.ACTIVE,MissionState.BLOCKED,MissionState.RECOVERY_REQUIRED}, MissionState.HANDOFF_PENDING:{MissionState.ACTIVE,MissionState.VALIDATION_PENDING,MissionState.INTEGRATION_PENDING,MissionState.RECOVERY_REQUIRED},
 MissionState.VALIDATION_PENDING:{MissionState.ACTIVE,MissionState.INTEGRATION_PENDING,MissionState.RECOVERY_REQUIRED,MissionState.SUSPENDED}, MissionState.INTEGRATION_PENDING:{MissionState.ACTIVE,MissionState.COMPLETE,MissionState.RECOVERY_REQUIRED},
 MissionState.SUSPENDED:{MissionState.READY,MissionState.ACTIVE,MissionState.RECOVERY_REQUIRED,MissionState.RETIRED}, MissionState.RECOVERY_REQUIRED:{MissionState.BOOTSTRAP_PENDING,MissionState.SUSPENDED,MissionState.RETIRED},
 MissionState.RETIRED:set(), MissionState.COMPLETE:{MissionState.RETIRED,MissionState.RECOVERY_REQUIRED}}
