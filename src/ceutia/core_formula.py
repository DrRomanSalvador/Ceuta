...
class SystemicVariables(BaseModel):
    """Variables fundamentales para el cálculo de susceptibilidad sistémica[span_4](start_span)[span_4](end_span)[span_5](start_span)[span_5](end_span)."""
...
class MasterSusceptibilityEngine:
    """Implementación de la fórmula integral de susceptibilidad y riesgo sistémico[span_6](start_span)[span_6](end_span)[span_7](start_span)[span_7](end_span)."""

    @staticmethod
    compute_systemic_susceptibility(vars: SystemicVariables) -> Dict[str, Any]:
        """
